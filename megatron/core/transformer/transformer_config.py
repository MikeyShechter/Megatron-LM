...
class TransformerConfig(ModelParallelConfig):
    ...
    init_moe_router_zero: bool = False
    """Initialize MoE router weights to zero instead of using init_method."""
    ...
    moe_load_balance_ste_width: float = field(
        default=0.0,
        metadata={
            "argparse_meta": {
                "arg_names": ["--moe-load-balance-ste-width", "--load-balance-ste-width"]
            }
        },
    )
    ...
    metagrad_lr: float = 0.0
    """Adam learning rate for scalar meta-gradient load-balance parameters."""
    ...
    def __post_init__(self):
        ...
        if self.moe_router_enable_expert_bias and self.moe_router_score_function not in (
            ...
            raise ValueError(
                ...
                "and 'softmax' score functions. Please set --moe-router-score-function to one "
                "of these, or unset --moe-router-enable-expert-bias."
            )
